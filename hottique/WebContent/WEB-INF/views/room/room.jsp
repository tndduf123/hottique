		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides" >
						<li><img src="<%=cp%>/resouces/img/slides/flexslider/room2_1.jpg" alt="" />
							
						</li>
						<li><img src="<%=cp%>/resouces/img/slides/flexslider/room2_2.jpg" alt="" />
							
						</li>
						<li><img src="<%=cp%>/resouces/img/slides/flexslider/room2_3.jpg" alt="" />
						
						</li>
					
						<li><img src="<%=cp%>/resouces/img/slides/flexslider/room2_4.jpg" alt="" />
						
						</li>
						
						<li><img src="<%=cp%>/resouces/img/slides/flexslider/room2_5.jpg" alt="" />
