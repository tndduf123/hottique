...
<body>
   ...
   <div id="wrapper">
 	...
 	<div style="width: 1140px; min-height: 500px; margin: 0px auto 50px;">	
		<div id="introduce">
			<div class="introduce_wrapper mk-grid">
				<h1 class="title_custom">rooms</h1>
				<h4><span>객실정보 페이지 입니다.</span></h4>
			</div>
		</div>
		<div class="mk-grid mk-main-wrapper theme-page-wrapper full-layout"> 
			<div class="theme-content">
					<img  src="<%=cp%>/resouces/img/slides/flexslider/room.jpg">
			</div>	
		</div>
	</div>
